                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="" value="{{$owner->user_name}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Name<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="" value="{{$owner->name}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Current Balance<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="" value="{{number_format($owner->wallet->balanceFloat, 2)}}" readonly>
                                </div>
                                <div class="form-group">
